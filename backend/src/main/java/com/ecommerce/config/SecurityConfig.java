    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/admin/products/template").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/coupons/admin/template").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/admin/uploads/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/admin/uploads").hasAnyRole("ADMIN", "MANAGER", "STAFF")
